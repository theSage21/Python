...
class Matrix:
    ...
    # MATRIX MANIPULATION
    def add_row(self, row: List[int], position: Optional[Any] = None) -> None:
    ...
    def add_column(self, column: List[int], position: Optional[Any] = None) -> None:
