...
def vol_cube(side_length: int) -> float:
    """Calculate the Volume of a Cube."""
    # Cube side_length.
    return float(side_length ** 3)


def vol_cuboid(width: int, height: int, length: int) -> float:
    """Calculate the Volume of a Cuboid."""
    # Multiply lengths together.
    return float(width * height * length)


def vol_cone(area_of_base: int, height: int) -> float:
    """
...
def vol_right_circ_cone(radius: int, height: int) -> float:
    """
...
def vol_prism(area_of_base: int, height: int) -> float:
    """
...
def vol_pyramid(area_of_base: int, height: int) -> float:
    """
    Calculate the Volume of a Prism.
...
def vol_sphere(radius: int) -> float:
    """
...
def vol_circular_cylinder(radius: int, height: int) -> float:
