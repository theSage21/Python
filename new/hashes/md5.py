...
def rearrange(bitString32: str) -> str:
    """[summary]
...
def getBlock(bitString: str) -> Iterator[Union[Iterator, Iterator[List[int]]]]:
    """[summary]
    Iterator:
