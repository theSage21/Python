...
def __decryptPart(messagePart: str, character2Number: Dict[str, str]) -> Tuple[str, str, str]:
    tmp, thisPart = "", ""
    result = []
...
def __prepare(message: str, alphabet: str) -> Tuple[str, str, Dict[str, str], Dict[str, str]]:
...
def encryptMessage(message: str, alphabet: str = "ABCDEFGHIJKLMNOPQRSTUVWXYZ.", period: int = 5) -> str:
...
def decryptMessage(message: str, alphabet: str = "ABCDEFGHIJKLMNOPQRSTUVWXYZ.", period: int = 5) -> str:
    message, alphabet, character2Number, number2Character = __prepare(message, alphabet)
    decrypted_numeric = []
    decrypted = ""
