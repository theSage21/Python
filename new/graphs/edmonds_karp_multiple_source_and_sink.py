collect_types.start()
class FlowNetwork:
    def __init__(self, graph: List[List[int]], sources: List[int], sinks: List[int]) -> None:
    ...
    def _normalizeGraph(self, sources: List[int], sinks: List[int]) -> None:
        if sources is int:
            sources = [sources]
        if sinks is int:
            sinks = [sinks]
    ...
    def setMaximumFlowAlgorithm(self, Algorithm: type) -> None:
        self.maximumFlowAlgorithm = Algorithm(self)


class FlowNetworkAlgorithmExecutor(object):
    def __init__(self, flowNetwork: FlowNetwork) -> None:
...
class PushRelabelExecutor(MaximumFlowAlgorithmExecutor):
    ...
    def processVertex(self, vertexIndex: int) -> None:
    ...
    def push(self, fromIndex: int, toIndex: int) -> None:
    ...
    def relabel(self, vertexIndex: int) -> None:
        minHeight = None
