...
def max_sum_from_start(array: List[int]) -> int:
...
def max_cross_array_sum(array: List[int], left: int, mid: int, right: int) -> int:
...
def max_subarray_sum(array: List[int], left: int, right: int) -> int:
