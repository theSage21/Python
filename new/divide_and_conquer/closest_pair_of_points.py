...
def euclidean_distance_sqr(point1: Tuple[int, int], point2: Tuple[int, int]) -> int:
    """
...
def column_based_sort(array: List[Tuple[int, int]], column: int = 0) -> List[Tuple[int, int]]:
    """
...
def dis_between_closest_pair(points: List[Tuple[int, int]], points_counts: int, min_dis: float = float("inf")) -> int:
    """
...
def dis_between_closest_in_strip(points: List[Tuple[int, int]], points_counts: int, min_dis: int = float("inf")) -> int:
    """
...
def closest_pair_of_points_sqr(points_sorted_on_x: List[Tuple[int, int]], points_sorted_on_y: List[Tuple[int, int]], points_counts: int) -> int:
...
def closest_pair_of_points(points: List[Tuple[int, int]], points_counts: int) -> float:
    """
