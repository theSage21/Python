...
def _construct_points(list_of_tuples: List[Tuple[int, int]]) -> List[Point]:
    """
...
def _validate_input(points: List[Tuple[int, int]]) -> List[Point]:
    """
...
def _det(a: Point, b: Point, c: Point) -> int:
    """
...
def convex_hull_bf(points: List[Tuple[int, int]]) -> List[Point]:
    """
...
def convex_hull_recursive(points: List[Tuple[int, int]]) -> List[Point]:
    """
